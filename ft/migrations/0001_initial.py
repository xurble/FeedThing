    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('salutation', models.CharField(blank=True, max_length=128, null=True, verbose_name='What should we call you?')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('source', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='feeds.Source')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subscription', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='ft.Subscription')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'ordering': ['-date_saved'],
