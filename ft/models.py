...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    salutation = models.CharField(
        max_length=128, null=True, blank=True, verbose_name="What should we call you?"
    )

    is_active = models.BooleanField(default=True)
    is_staff = models.BooleanField(default=False)

    default_to_river = models.BooleanField(
        default=False,
        help_text="Set your default home to be a river of all your feeds.",
    )
